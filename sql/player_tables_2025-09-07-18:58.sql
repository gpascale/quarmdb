...
CREATE TABLE `account` (
  ...
  `revokeduntil` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `force_guild_id` int(11) NOT NULL DEFAULT 0,
  `forum_name` varchar(32) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`) USING BTREE,
  UNIQUE KEY `lsaccount_id` (`lsaccount_id`) USING BTREE,
  KEY `forum_name` (`forum_name`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=117488 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `character_data` (
  ...
  `e_temp_last_name` varchar(64) NOT NULL DEFAULT '',
  `e_married_character_id` int(11) NOT NULL DEFAULT 0,
  `e_char_export_flag` tinyint(3) unsigned NOT NULL DEFAULT 0,
  `e_times_rebirthed` int(11) NOT NULL DEFAULT 0,
  `e_ng_respecs_remaining` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`) USING BTREE,
  KEY `account_id` (`account_id`) USING BTREE,
  KEY `e_hardcore` (`e_hardcore`),
  KEY `mailkey` (`mailkey`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=309196 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `character_corpses` (
  ...
  `zone_guild_id` int(11) unsigned NOT NULL DEFAULT 4294967295,
  PRIMARY KEY (`id`),
  KEY `zoneid` (`zone_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1437591 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `character_legacy_items` (
  ...
  `expire_time` bigint(24) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`character_id`,`item_id`) USING BTREE,
  KEY `Index_CharacterID` (`character_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `character_loot_lockouts` (
  ...
  `npc_name` varchar(64) NOT NULL DEFAULT 'INVALID',
...
CREATE TABLE `character_spells` (
  ...
  KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=309191 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `character_buffs` (
  ...
  `bufftype` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`,`slot_id`),
...
CREATE TABLE `guilds` (
  ...
  `raid_enabled` smallint(5) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`) USING BTREE,
...
CREATE TABLE `guild_members` (
  ...
  PRIMARY KEY (`char_id`),
  KEY `charid` (`char_id`,`guild_id`),
  KEY `charid_only` (`char_id`) USING BTREE,
  KEY `guildid_only` (`guild_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `hackers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2734226 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `merchantlist_temp` (
  `npcid` int(10) unsigned NOT NULL DEFAULT 0,
  `slot` smallint(8) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `qs_player_npc_kill_log` (
  ...
  `time` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  KEY `charid` (`char_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `qs_player_speech` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `from` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `to` varchar(325) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `message` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `timerecorded_TS` (`timerecorded`) USING HASH,
  KEY `name_from` (`from`) USING BTREE,
  KEY `character_id_from` (`characterid`) USING BTREE,
  KEY `name_to` (`to`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=243664328 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=COMPRESSED;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `raid_members` (
  ...
  `is_officer` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `respawn_times` (
  ...
  `guild_id` int(11) unsigned NOT NULL DEFAULT 4294967295,
  PRIMARY KEY (`id`,`guild_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=153460 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
